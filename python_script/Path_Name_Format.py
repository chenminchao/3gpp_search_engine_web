...
SLICE_HTML_PATH = "{basedir}/spec/{ver}/{series}.{num}/slice_html"
DOC_NAME = "{basedir}/spec/{ver}/{series}.{num}/doc/{series}{num}-{ver}.doc"
DOCX_NAME = "{basedir}/spec/{ver}/{series}.{num}/doc/{series}{num}-{ver}.docx"
ZIP_NAME = "{basedir}/spec/{ver}/{series}.{num}/zip/{series}{num}-{ver}.zip"
